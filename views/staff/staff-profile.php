...
<body>
    <div class="container profile-container">
        <h1 class="mb-4">Staff Profile</h1>

        <!-- Basic Information Section -->
        <div class="card mb-4">
            <div class="card-body">
                <h5 class="card-title">Basic Information</h5>
                <p><strong>Identifier:</strong> <span id="staff-identifier">[Loading...]</span></p>
                <p><strong>First Name:</strong> <span id="staff-firstname">[Loading...]</span></p>
                <p><strong>Middle Name:</strong> <span id="staff-middlename">[Loading...]</span></p>
                <p><strong>Last Name:</strong> <span id="staff-lastname">[Loading...]</span></p>
                <p><strong>Email:</strong> <span id="staff-email">[Loading...]</span></p>
                <p><strong>Username:</strong> <span id="staff-username">[Loading...]</span></p>
                <p><strong>Department:</strong> <span id="staff-department">[Loading...]</span></p>
    ...
    <!-- <script src="/cssc/js/staff-profile.js"></script> -->
</body>
</html>
