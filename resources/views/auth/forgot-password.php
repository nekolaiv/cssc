...
<body>
    <form id="myForm" action="" method="POST">
        ...
        <input type="password" name="new-password" id="new-password" placeholder="password" class="password" value="<?php echo htmlspecialchars($new_password); ?>">
        ...
        <input type="password" name="confirm-password" id="confirm-password" placeholder="confirm password" class="password" value="<?php echo htmlspecialchars($confirm_password); ?>">
        <div class="below-input">
